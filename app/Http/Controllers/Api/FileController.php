...
use App\Jobs\UnzipAndProcessFile;
...
class FileController extends Controller
{
    public function extractZipFile(Request $request)
    {
        if ($request->hasFile('zip')) {
            ...
            $path = $file->storeAs('zip', $originalFileName, 'public');
            // Optionally, store file information in the database
            // $storedFile = YourFileModel::create(['file_path' => $path]);
            UnzipAndProcessFile::dispatch($path);
