                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @php
                                                ...
                                                $mac_id = $item->mac_id;
                                                $AnalyserLatest = App\Models\Analyser::where('cameraMacAddress', $mac_id)
                                                    ->latest()
                                                    ->first();

                                                $dateTime = $AnalyserLatest ? Carbon\Carbon::parse($AnalyserLatest->created_at) : null;

                                                if ($dateTime) {
                                                    $currentDateTime = Carbon\Carbon::now();
                                                    $timeDifference = $currentDateTime->diffInMinutes($dateTime);
                                                    ...
                                                    // No record found, consider as offline
                                                    echo '<span style="color: red;"><b>Offline</b></span>';
                                                }
                                            @endphp
                                        </td>
